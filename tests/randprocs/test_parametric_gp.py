...
def parametric_gp(
...
) -> luno.randprocs.ParametricGaussianProcess:
    ...
    return luno.randprocs.ParametricGaussianProcess.from_weights_and_features(
        weight_mean,
        weight_cov,
        features,
    )
...
def test_sample_fn(parametric_gp: luno.randprocs.ParametricGaussianProcess):
...
def test_sample(parametric_gp: luno.randprocs.ParametricGaussianProcess):
